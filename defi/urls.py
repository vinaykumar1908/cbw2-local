...
urlpatterns = [
    ...
    path('showTCdet2/<int:Serial>/', views.showTCdet2, name='showTCdet2'),
    path('showMCdet/<int:Serial>/', views.showMCdet, name='showMCdet'),
    path('showMCdet2/<int:Serial>/', views.showMCdet2, name='showMCdet2'),
    ...
    path('DPCExcelExport/<int:Serial>/', views.export_dpc_remark, name='DPCExcelExport'),
